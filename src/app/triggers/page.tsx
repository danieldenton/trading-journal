const placeholderTriggers = [
  ...
  { name: "AMD", successCount: 6, failureCount: 1 },
];
...
export default function TriggersPage() {
  return (
    ...
    // 1. Make an input to create a new trigger
    // 2. Make a list of triggers
    // 3. Next to each trigger there should be 3 comlumns: 1. successCount 2. failureCount 3. Win Rate
    //  The list should be sorted by win rate.
  );
}
